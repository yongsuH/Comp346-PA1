...
public class Client extends Thread{ 
     ...
     */
     public void receiveTransactions(Transactions transact)
     {
         ...
         //System.out.println(getNumberOfTransactions());
         while (i < (getNumberOfTransactions()))
         {     
    ...
    {   
    	...
    	sendClientStartTime = receiveClientStartTime = System.currentTimeMillis();
    	// Sending thread
    	if (clientOperation == "sending") {
    		sendTransactions();
    		sendClientEndTime = System.currentTimeMillis();
    		long runningTime = sendClientEndTime - sendClientStartTime;
    		System.out.println("\n Terminating client sending thread - Running time " + runningTime + " milliseconds");
    	}else {
    	// receiving thread
    		receiveTransactions(transact);
    		receiveClientEndTime = System.currentTimeMillis();
    		long runningTime2 = receiveClientEndTime - receiveClientStartTime;
    		
    		//System.out.println(objNetwork.getClientConnectionStatus());
    		objNetwork.disconnect(objNetwork.getClientIP());
    		//System.out.println(objNetwork.getClientConnectionStatus());
    		//System.out.println(objNetwork.getServerConnectionStatus());
    		System.out.println("\n Terminating client receiving thread - Running time " + runningTime2 + " milliseconds");
    	}
    }
}
